			...
			>
				<div className='p-6 sm:p-8'>
					...
					<p className='text-gray-300 text-center mb-6'>
						Tu pedido ha sido cancelado, no se te ha realizado ningun cargo.
					</p>
					<div className='bg-gray-700 rounded-lg p-4 mb-6'>
						<p className='text-sm text-gray-400 text-center'>
							Si has encontrado algun fallo durante el checkout &apos; no tengas duda en contactar con nuestro soporte 	
						</p>
					</div>
