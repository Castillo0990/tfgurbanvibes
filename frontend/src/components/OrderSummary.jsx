...
const stripePromise = loadStripe(
	"pk_test_51RVybbCpOHfYokoYaPWfl8cDdAm9TAHw05CnLE4AXD4U57oYA1dOLJc8TxOgwfYJYO903u9DbMfZqwFN3nxHoHAY00PKxgxgS2"
);
		...
		>
			...
			<div className='space-y-4'>
				<div className='space-y-2'>
					...
					{savings > 0 && (
						<dl className='flex items-center justify-between gap-4'>
							<dt className='text-base font-normal text-gray-300'>Ahorro</dt>
